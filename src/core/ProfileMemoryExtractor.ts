...
export interface ProfileMemoryExtractorOptions {
  profilePrivacy?: Partial<UserProfilePrivacySettings>;
}

/**
 * Extracts durable user-profile signals (preferences, interests, emotional
 * state, behavioral patterns) from raw episodes.
 *
 ...
 */
export class ProfileMemoryExtractor {
  private privacy: UserProfilePrivacySettings;

  constructor(options: ProfileMemoryExtractorOptions = {}) {
    this.privacy = {
